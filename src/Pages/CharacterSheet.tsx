  ...
  return (
    <main className={`${styles.sheet} sheet`}>
      <div className={styles.header}>
        <SheetBox className={styles.headerBox}>
          <LicenseHeader />
        </SheetBox>
      </div>

      <div className={styles.attributes}>
        <SheetBox title="Attributes" variant="terminal" className={styles.attributesBox}>
      ...
      <div className={styles.info}>
        <SheetBox title="Character Info" variant="terminal" className={styles.infoBox}>
          <SheetFormGrid>
      ...
      <div className={styles.combat}>
        <SheetBox title="Combat" variant="terminal" className={styles.combatBox}>
          <SheetFormGrid>
      ...
      <div className={styles.personality}>
        <SheetBox title="Personality" variant="terminal" className={styles.personalityBox}>
          <SheetFormGrid>
      ...
      <div className={styles.skills}>
        <SheetBox title="Skills" variant="terminal" className={styles.skillsBox}>
          <SheetFormGrid>
      ...
      <div className={styles.features}>
        <SheetBox title="Features & Traits" variant="terminal" className={styles.featuresBox}>
          <SheetFormGrid>
